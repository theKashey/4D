...
NEINLINE void	neM4::Set44(float row00, float row01, float row02, float row03
					, float row10, float row11, float row12, float row13
					, float row20, float row21, float row22, float row23
					, float row30, float row31, float row32, float row33)
{
    M[0][0] = row00; M[0][1] = row01; M[0][2] = row02; M[0][3] = row03;
    M[1][0] = row10; M[1][1] = row11; M[1][2] = row12; M[1][3] = row13;
    M[2][0] = row20; M[2][1] = row21; M[2][2] = row22; M[2][3] = row23;
    M[3][0] = row30; M[3][1] = row31; M[3][2] = row32; M[3][3] = row33;
}
...
NEINLINE neV4 operator * ( const neM4& M, const neV4& V )
{
	neV4 tmp;
    return tmp.Set ( M.M[0][0] * V.X + M.M[1][0] * V.Y + M.M[2][0] * V.Z + M.M[3][0] * V.W,
